            ...
            <div class="row breadcrumbs-top">
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Cancel Orders
                    </li>
                  </ol>
                </div>
              </div>
...
<center><div class="dabge col-md-12" id="messagediv"></div></center>
		...
		foreach($data as $data_cat){
            ...
            echo'<tr>
              ...
              <td>&#8377; '.$subtotal.'</td>
              <td>'.$status.'</td>
              <td><a href="'.base_url().'CancelOrdersList?oid='.base64_encode($data_cat->oid).'" class="btn btn-primary btn-sm ">View List</a></td>
            </tr>';
        }
          ?>
                </tbody>
