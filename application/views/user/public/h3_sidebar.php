...
if (!empty($this->session->userdata('user'))) {
  ?>
       <div class="user-profile"><img src="<?=base_url()?>app-assets/user/img/bg-img/<?= $this->session->userdata('user')->image ?>" alt=""></div>
  <?php
}
else
{
  ?>
       <div class="user-profile"><img src="<?=base_url()?>app-assets/user/img/bg-img/default.png" alt=""></div>
  <?php
}
  ?>
        ...
        <div class="user-info">
          <h6 class="user-name mb-0">
            <?php
if (!empty($this->session->userdata('user'))) {
 echo '<a class="text-white" href="'.base_url().'user-profile">'.$this->session->userdata('user')->Name.'</a>';
}
else
{
  ?>
  <a href="<?=base_url()?>User-Login" class="text-white">Login / Register</a>
  <?php
}
  ?>
...
<path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
        ...
        <li><a href="<?= base_url()?>user-cat">
            <svg width="16" height="16" viewBox="0 0 16 16" class="bi bi-grid-3x3-gap" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<li><a href="<?= base_url()?>user-profile">
            <svg width="16" height="16" viewBox="0 0 16 16" class="bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" d="M13 14s1 0 1-1-1-4-6-4-6 3-6 4 1 1 1 1h10zm-9.995-.944v-.002.002zM3.022 13h9.956a.274.274 0 0 0 .014-.002l.008-.002c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664a1.05 1.05 0 0 0 .022.004zm9.974.056v-.002.002zM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"></path>
</svg>My Account</a></li>
<li><a href="<?= base_url()?>Orders">
            <svg width="16" height="16" viewBox="0 0 16 16" class="bi bi-cart-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<li><a href="<?= base_url()?>Privacy-Policy">
            <svg width="16" height="16" viewBox="0 0 16 16" class="bi bi-lock" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<li><a href="<?= base_url()?>Contact-Us">
            <svg width="16" height="16" viewBox="0 0 16 16" class="bi bi-question-octagon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
