(function () {
    ...
    // autocomplete form function
    function autocomplete(inp, arr) {
        var currentFocus;
        inp=document.getElementById("autoCompletePlace");
    ...
    var places = ['Kabul', 'Tirana', 'Algiers', 'Luanda', 'Saint', 'Johns', 'Buenos', 'Aires', 'Yerevan', 'Canberra', 'Vienna', 'Baku', 'Nassau', 'Manama', 'Dhaka', 'Bridgetown', 'Minsk', 'Brussels', 'Belmopan', 'Porto', 'Novo', 'Thimphu', 'Sarajevo', 'Gaborone', 'Brasilia', 'Sofia', 'Ouagadougou', 'Gitega', 'Praia', 'Phnom', 'Penh', 'Yaounde', 'Ottawa', 'Bangui', 'Djamena', 'Santiago', 'Beijing', 'Bogotá', 'Moroni', 'Kinshasa', 'Brazzaville', 'San', 'Jose', 'Yamoussoukro', 'Zagreb', 'Havana', 'Nicosia', 'Prague', 'Suva', 'Helsinki', 'Paris', 'Libreville', 'Banjul', 'Tbilisi', 'Berlin', 'Accra', 'Athens', 'Saint', 'Georges', 'Guatemala', 'City', 'Conakry', 'Bissau', 'Georgetown', 'Reykjavik', 'New', 'Delhi', 'Jakarta', 'Tehran', 'Baghdad', 'Dublin', 'Jerusalem', 'Rome', 'Kingston', 'Tokyo', 'Amman', 'NurSultan', 'Nairobi', 'Tarawa', 'Pristina', 'Kuwait', 'City', 'Bishkek', 'Vientiane', 'Riga', 'Beirut', 'Maseru', 'Monrovia', 'Tripoli', 'Vaduz', 'Vilnius', 'Luxembourg'];
